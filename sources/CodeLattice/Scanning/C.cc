...
//@-node:gcross.20100315191926.1594:Type aliases
//@+node:gcross.20100315191926.1440:Global variables
static operator_vector_t operators;
//@-node:gcross.20100315191926.1440:Global variables
//@+node:gcross.20100315191926.1439:Functions
//@+node:gcross.20100315191926.1438:initialize_scanner
extern "C" void initialize_scanner(int number_of_qubits, int number_of_operators) {
...
extern "C" int update_operators_and_solve(int* restrict operator_table, int* restrict values) {
    BOOST_FOREACH(operator_t& op, operators) {
